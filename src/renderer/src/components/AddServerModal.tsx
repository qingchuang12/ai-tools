      ...
      <div className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button
              onClick={addEnvVar}
              className="text-[12px] text-[var(--color-accent)] hover:text-[var(--color-info)]"
            >
              + {t('common.add') || 'Add'}
            </button>
          </div>
              ...
              {envVars.map((env, index) => (
                <div key={index} className="flex gap-2">
                  <input
                    ...
                    placeholder="KEY"
                    className="flex-1 px-3 py-2 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg text-[13px] text-[var(--color-text)] placeholder:text-[var(--color-muted)] focus:outline-none focus:border-[var(--color-accent)]"
                  />
                  <input
                    type="text"
                    value={env.value}
                  ...
                  <button
                    ...
                    className="px-2 text-[var(--color-danger)] hover:opacity-70"
                  >
        ...
        <div>
          <label className="block text-[12px] text-[var(--color-muted2)] mb-1.5">
            {t('addServer.targetClients') || 'Target Clients'} <span className="text-[var(--color-danger)]">*</span>
          </label>
          {availableClients.length === 0 ? (
            ...
            <ClientMultiSelect
              ...
              selectedClass="border-[var(--color-accent)] bg-[color-mix(in_srgb,var(--color-accent)_10%,transparent)]"
        ...
        <div className="border-t border-[var(--color-border)] pt-4">
          <button
            ...
            className="flex items-center gap-2 text-[13px] text-[var(--color-accent)] hover:text-[var(--color-info)]"
          >
...
// 或 HTTP 模式：
{
  "url": "http://localhost:8000/mcp"
                ...
                className="w-full h-32 px-3 py-2 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-lg text-[12px] text-[var(--color-text)] font-mono placeholder:text-[var(--color-muted)] focus:outline-none focus:border-[var(--color-accent)] resize-none"
              />
              {parseError && (
